...
6. **Δοκίμασε το bot διαδραστικά (interactive mode)**
   ```bash
   rasa interactive
   ```
   Η εντολή `rasa interactive` σου επιτρέπει να μιλάς με το bot και ταυτόχρονα να βλέπεις πώς αναγνωρίζει τις προθέσεις (intents) και τα entities σε κάθε μήνυμά σου. Σε κάθε βήμα μπορείς να επιβεβαιώσεις ή να διορθώσεις τις αποφάσεις του bot — και στο τέλος, οι διορθώσεις σου αποθηκεύονται αυτόματα ως νέα training data (stories και NLU examples). Είναι ο πιο εύκολος τρόπος να βελτιώσεις το bot σου βήμα-βήμα!
